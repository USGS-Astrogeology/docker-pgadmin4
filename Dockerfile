...
RUN pip install https://ftp.postgresql.org/pub/pgadmin/pgadmin4/v2.1/pip/pgadmin4-2.1-py2.py3-none-any.whl --trusted-host=ftp.postgresql.org --trusted-host=pypi.python.org
